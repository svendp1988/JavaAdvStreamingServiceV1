...
public class CreditCardNumber {
    ...
    public CreditCardNumber(String number, String cvc) {
        ...
        this.cvc = assertCorrectCvc(cvc);
    }

    private String assertCorrectCvc(String cvc) {
        String toVerify = removeBlanks(cvc);
        if (!isNumeric(toVerify) || toVerify.length() != CVC_LENGTH) {
